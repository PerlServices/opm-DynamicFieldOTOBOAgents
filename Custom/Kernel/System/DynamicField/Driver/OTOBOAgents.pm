...
package Kernel::System::DynamicField::Driver::OTOBOAgents;
...
Kernel::System::DynamicField::Driver::OTOBOAgents

=head1 SYNOPSIS

DynamicFields OTOBOAgents Driver delegate
...
sub new {
    ...
    my $DynamicFieldDriverExtensions
        = $Kernel::OM->Get('Kernel::Config')->Get('DynamicFields::Extension::Driver::OTOBOAgents');
